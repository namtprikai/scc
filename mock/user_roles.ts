...
interface IUserRole extends ICrossReferenceTable{
	id: number;
	role_id: number;
	user_id: number;
};
class UserRoleModel extends CrossReferenceTable<IUserRole> {

	public getUserRolesByUserId(user_id: number,table:Array<IUserRole>) {
