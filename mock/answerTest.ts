...
import { IConditionData, IConditionGroupData, IQuestionData } from '../src/core/api/types';
...
export const getTestAnser=(questionId:number,conditions?:Array<IConditionData>)=>{
