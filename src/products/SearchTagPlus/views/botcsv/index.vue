	...
	<div>
		<b-row class="ml-0">
			<b-col lg="12" class="pb-2 ml-0">
				<b-form-file accept=".csv" v-model="file" :state="Boolean(file)" placeholder="ファイルを選択してください" drop-placeholder="Drop file here..." browse-text="選択"></b-form-file>
			</b-col>
		</b-row>
		<b-row v-if="Boolean(file)" class="ml-0">
			<b-col lg="4" class="pb-2">
				<b-button v-on:click="save"><b-spinner small v-if="isUpload"></b-spinner>アップロード</b-button>
			</b-col>
...
export default class Botcsv extends BotcsvParent {}
</script>
