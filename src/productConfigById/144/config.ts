...
export const WindowTestPageUrl: string = process.env.DEV_WINDOW_URL || '';
export const WindowPageUrl: string = process.env.PRODUCT_WINDOW_URL||'https://service.ai-x-supporter-dev.com/saichat_small/';
