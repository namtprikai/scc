...
export const WindowTestPageUrl: string = 'https://service.ai-x-supporter-dev.com/sai_search_tag_demo2_test/';
export const MaxFaqSize = 500;
export const WindowPageUrl: string = 'https://service.ai-x-supporter-dev.com/sai_search_tag_demo2/';
