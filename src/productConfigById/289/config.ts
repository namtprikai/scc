...
export const WindowTestPageUrl: string = 'https://service.ai-x-supporter-dev.com/search_tag_plus_demo_test/';
export const MaxFaqSize = 500;
export const WindowPageUrl: string = 'https://service.ai-x-supporter-dev.com/search_tag_plus_demo/';
