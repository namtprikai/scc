...
export const WindowTestPageUrl: string = process.env.DEV_WINDOW_URL || 'https://service.ai-x-supporter.com/hozen_762_test/';
export const MaxFaqSize = 500;
export const WindowPageUrl: string = process.env.PRODUCT_WINDOW_URL || 'https://hozen-support.ai-x-supporter.com/';
