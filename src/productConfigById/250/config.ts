...
export const WindowTestPageUrl: string = 'https://service.ai-x-supporter.com/his_faq_test_250_test/';
export const MaxFaqSize = 500;
export const WindowPageUrl: string = 'https://service.ai-x-supporter.com/his_faq_test_250/';
