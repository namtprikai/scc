...
export const WindowTestPageUrl: string = process.env.DEV_WINDOW_URL || 'https://service.ai-x-supporter.com/star_659_test/';
export const MaxFaqSize = 500;
export const WindowPageUrl: string = process.env.PRODUCT_WINDOW_URL || 'https://service.ai-x-supporter.com/star_659/';
