...
export const WindowPageUrl: string = 'https://service.ai-x-supporter.com/nec_ope/';
export const WindowTestPageUrl: string = 'https://service.ai-x-supporter.com/nec_ope_test/';
