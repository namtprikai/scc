...
export const WindowPageUrl: string = 'https://service.ai-x-supporter-dev.com/search_window_plus_demo/';
...

     {
						...
						children: [
								...
								meta: {
									...
									v2: {
										default: 'DefaultSearchMessageProd',
										tabs: [
											// {
											// 	label: "テスト環境",
											// 	key: "DefaultChatMessageTest",
											...
											{
												label: '本番環境',
												key: 'DefaultSearchMessageProd',
												component: 'DefaultSearchMessage',
												tabtype: 'prod',
												discription: '本番環境で表示されている文言です。',
											},
											// {
					...
					},
					{
                      ...
                      // { label: "ボット表示設定", key: "DefaultSearchMessage", discription: "表示文言を、自由に設定できます。<br>「更新」ボタンをクリックすると、即時反映されますのでご注意ください。" },
										],
									},
								},
              },
			...
			// },
			{
				...
				children: [
                    ...
                    // { label: "要編集メッセージ", key: "ScriptFeedback", all: false },
                  ],
									},
									v2: {
