...
export const WindowTestPageUrl: string = 'https://service.ai-x-supporter-dev.com/sales_sai_search_tag_demo_test/';
export const MaxFaqSize = 500;
export const WindowPageUrl: string = 'https://service.ai-x-supporter-dev.com/sales_sai_search_tag_demo/';
