...
export const WindowTestPageUrl: string = process.env.DEV_WINDOW_URL || 'https://service.ai-x-supporter.com/star_333_test/';
export const MaxFaqSize = 500;
export const WindowPageUrl: string = process.env.PRODUCT_WINDOW_URL || 'https://www.tokyostarbank.co.jp/index.html';
