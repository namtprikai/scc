...
export const WindowPageUrl: string = 'https://service.ai-x-supporter.com/sedia_system/';
export const WindowTestPageUrl: string = 'https://service.ai-x-supporter.com/sedia_system_test/';
									...
									v2: {
										...
										tabs: [
											{ label: 'FAQ編集', key: 'AllInOneEditor' },
											{
												label: "よくある質問",
												key: "Yokuaru",
												discription: `・追加するには、FAQ一覧からQ&Aを選択して「選択したQ&Aをよくある質問に追加」をクリックしてください。削除するには「-」ボタンをクリックしてください。
