...
export const WindowPageUrl: string = 'https://service.ai-x-supporter.com/spi_faq/';
export const WindowTestPageUrl: string = 'https://service.ai-x-supporter.com/spi_faq_test/';
