...
export const WindowTestPageUrl: string = process.env.DEV_WINDOW_URL || 'https://service.ai-x-supporter.com/rakuten_insurance_inhouse_test/';
export const MaxFaqSize = 500;
export const WindowPageUrl: string = process.env.PRODUCT_WINDOW_URL || 'https://rakuten-insurance-inhouse-support.ai-x-supporter.com/';
