...
export const WindowTestPageUrl: string = 'https://service.ai-x-supporter.com/kraft_458_test/';
export const MaxFaqSize = 500;
export const WindowPageUrl: string = 'https://service.ai-x-supporter.com/kraft_458/';
