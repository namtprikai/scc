...
export const WindowTestPageUrl: string = 'https://service.ai-x-supporter.com/kajima_page_test/';
export const MaxFaqSize = 500;
export const WindowPageUrl: string = 'https://service.ai-x-supporter-dev.com/kajima_page/';
