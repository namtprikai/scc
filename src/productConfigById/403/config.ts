...
export const WindowPageUrl:string = "https://service.ai-x-supporter.com/jp_post_help";
...
return {
	...
	routes: [
							...
							meta: {
								...
								v1: {
									...
									tabs: [
										...
										{ label: "アカウントリスト", key: "AdminUser", roles: [5, 6, 999] },
										{
											label: "お知らせ",
											key: "Oshirase",
											roles: [4, 5, 6],
									...
									tabs: [
										{
											...
											tabtype: "dev",
											discription:
												"ボットに表示される文言を編集できます。<br>保存して反映するには「反映ステップに進む」を選択してください。",
										},
									],
								},
								v2: {
		...
		},
		{
			...
			redirect: "/script",
			name: "script",
			meta: { title: "FAQ設定", icon: "script", roles: [0, 1, 2, 3, 4, 5, 6, 999] },
			children: [
				{
					path: "index2",
									...
									tabs: [
										{
											...
											key: "KeywordEditor",
											discription:
												"キーワードの重みを変更できます。<br>編集を終えて適用するには「本番環境に反映」を選択してください。",
										},
									],
								},
								v2: {
					...
					children: [
						{
							...
							meta: {
								...
								v1: {
									...
									tabs: [{ label: "利用履歴", key: "TicketAnalyzer", discription: "検索ボタンを押すと利用履歴の集計結果をグラフなどで表示できます。" }],
								},
							},
						},
						{
							...
							meta: {
								...
								v1: {
									...
									tabs: [{ label: "精度検証", key: "ScriptEvaluation", discription: "CSVファイルのA列に検索クエリ、B列にヒットさせたい質問文を記載してアップロードしてください" }],
								},
							},
						},
					],
					...
					children: [
						{
							...
							meta: {
								...
								v1: {
									default: "AdminUser",
									tabs: [
										{ label: "ユーザー一覧", key: "AdminUser", roles: [5, 6, 999] },
