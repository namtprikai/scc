...
export const WindowPageUrl: string = 'https://service.ai-x-supporter-dev.com/boy_faq_page_test/';
...
export const UploadModalDiscription = `
	...
	<p>2. 「本番環境に反映」を選択してください。サーバーに保存されているボット表示設定とFAQ設定の内容が選択した環境に反映されます。</p>
	<p>※「保存して本番環境に反映」を選択すると保存と反映が同時に行われます。</p>
`;
...
const siteMapUrl = 'https://service.ai-x-supporter-dev.com/boy_faq_page_test/';
