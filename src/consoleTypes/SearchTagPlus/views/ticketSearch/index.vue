		...
		<b-row>
			<b-col lg="6">
				<barChart
					...
					v-bind:data="hourlyTicketCounts"
					width="100%"
					height="400px"
		...
		<b-row>
			<b-col lg="6">
				<barChart
					class="mx-auto my-2"
					v-loading="listLoading"
					v-bind:data="weeklyTicketCounts"
					width="100%"
					height="400px"
					titleText="曜日別チケット件数"
					valueUnit="件"
			...
			<b-col lg="6">
				<barChart
					class="mx-auto my-2"
					v-loading="listLoading"
					v-bind:data="monthlyTicketCounts"
					width="100%"
					height="400px"
					titleText="月別チケット件数"
					valueUnit="件"
		...
		<b-row>
			<b-col lg="6">
				<pieChart
					class="mx-auto my-2"
					v-loading="listLoading"
					v-bind:data="enquete1Counts"
					width="100%"
					height="400px"
					titleText="アンケート1回答結果"
					valueUnit="件"
				/>
			</b-col>
			<b-col lg="6">
				<pieChart
					class="mx-auto my-2"
					v-loading="listLoading"
					v-bind:data="enquete2Counts"
					width="100%"
					height="400px"
					titleText="アンケート2回答結果"
					valueUnit="件"
				/>
			</b-col>
		</b-row>
		...
		<b-row>
			<b-col lg="12">
				<barChart
					class="mx-auto my-2"
					v-loading="listLoading"
					v-bind:data="parentCategoryCounts"
					width="100%"
					height="400px"
					titleText="親カテゴリ別件数"
					valueUnit="件"
		...
		<b-row>
			<b-col lg="12">
				<barChart
					class="mx-auto my-2"
					v-loading="listLoading"
					v-bind:data="childCategoryCounts"
					width="100%"
					height="400px"
					titleText="子カテゴリ別件数"
					valueUnit="件"
