<template src="@/views/productions/index.vue"></template>
...
import PolycyGroupListParent from "@/views/policyGroupList/index.vue";
...
export default class PolycyGroupList extends PolycyGroupListParent {
	public isShow = true;
}
</script>
