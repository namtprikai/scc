<template src="@/views/productions/index.vue">
...
import ProductionsParent from '@/views/productions/index.vue';
...
export default class Productions extends ProductionsParent {
	public isShow = true;
}
</script>
