		...
		<div class="tab-body">
			...
			<div class="section">
				<b-form-group
					label-cols="4"
					label="メールアドレス"
					label-for="adduser-input-2"
					:invalid-feedback="invalidFeedbackMail"
					:valid-feedback="validFeedbackMail"
					:state="stateMail"
				>
					<b-form-input
						id="adduser-input-2"
...
export default class AddUser extends Vue {
	...
	get statePassword(): boolean | null {
		...
		return (
			this.passwordValidator.valid(this.pw1) &&
			this.passwordValidator.valid(this.pw2)
		);
	}
	...
	get isAddUser(): boolean | null {
		...
		return (
			this.stateName && this.stateMail && this.statePassword && this.matchPassword
		);
	}
}
</script>
