	...
	<div class="botFlow">
		<div v-if="botFlow">
			<div>
				...
				<h3>
					<b-form-group label>
						<b-form-radio-group v-model="botFlow.condition.type" buttons button-variant="outline-primary">
							<b-form-radio name="some-radios" value="number" :disabled="!isEdit">選択肢（数値）</b-form-radio>
							<b-form-radio name="some-radios" value="or" :disabled="!isEdit">質問文</b-form-radio>
						</b-form-radio-group>
					</b-form-group>
				...
				<div>
					...
					<b-button v-on:click="addItems()">ログ項目を追加する</b-button>
				</div>
...
export default class BotConfigTemp extends Vue {
	...
	private createTitle() {
		...
		if (this.botFlow) {
			...
			this.linkTitle(this.botFlow.step, this.botFlow.title);
		}
