<template>
  <div class="create-admin-container sm-container">
    ...
    <comfirm-modal
      ...
      @confirmDialogVisibleWasUpdated="dialogFormVisible = $event"
      >
    </comfirm-modal>
  </div>
...
export default class extends Vue {
  ...
  private async submit() {
    (this.$refs.createForm as ElForm).validate(async(valid: boolean) => {
      console.log('111:::', this.dialogFormVisible)
      this.dialogFormVisible = true
      console.log('222:::', this.dialogFormVisible)
      const dataConfirm = [
        { key: this.$t('labelText.loginName'), value: '2' },
        { key: this.$t('labelText.email'), value: '2' },
        { key: this.$t('labelText.isMasterAdmin'), value: true },
        { key: this.$t('labelText.config'), value: JSON.stringify({ key: 'value', key2: 1 }, null, 4), type: 'json' }
      ]
      this.confirmData = dataConfirm
